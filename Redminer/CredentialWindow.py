...
#         elif not check_credential_complete(credential_str):  # check_credential_sim - check length of key # check_credential_complete - send a real request to check (slow)
